<section class="sticky bg-white z-10">
	...
	>
		...
		<div class="skills grid grid-cols-3 md:w-1/2">
			<div class="skill bg-indigo-500">
				<p class="text-white">JavaScript</p>
			</div>
			<div class="skill bg-indigo-500">
				<p class="text-white">Svelte(Kit)</p>
			</div>
			<div class="skill bg-indigo-500">
				<p class="text-white">PHP</p>
			</div>
			<div class="skill bg-indigo-400">
				<p class="text-white">ReactJS</p>
			</div>
			<div class="skill bg-indigo-400">
